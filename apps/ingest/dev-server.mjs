...
// `lib/receiver.mjs`, partagée avec `services/ingest` (Railway) et alignée sur
...
import pg from "pg";
import { creerReceveur } from "./lib/receiver.mjs";
import { creerPool, demarrerServeur, cible } from "./lib/serveur.mjs";
