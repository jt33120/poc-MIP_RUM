...
| Étape | Où |
|---|---|
| Choix du fichier (`GEOIP_DB_PATH`, sinon la livraison la plus récente d'ici) | `apps/ingest/lib/geoip-db.mjs` |
| Chargement en mémoire, une seule fois, sans bloquer le démarrage | `apps/ingest/lib/geoip-db.mjs` |
| Analyse du CSV, dichotomie IPv4/IPv6, plages réservées | `apps/ingest/supabase/functions/_shared/geoip.mjs` |
| D'où vient l'adresse du client (`GEOIP_IP_SOURCE`) | `apps/ingest/supabase/functions/_shared/client-ip.mjs` |
| Écriture du pays et de sa provenance | `apps/ingest/lib/pg-ingest.mjs`, migration v85 |
