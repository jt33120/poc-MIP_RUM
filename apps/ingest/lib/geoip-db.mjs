...
import { ageEnJours, chargerBase, paysDe, versionDepuisNom } from "../supabase/functions/_shared/geoip.mjs";
 ...
 *   2. la livraison la plus récente déposée dans `apps/ingest/data/`.
 *
