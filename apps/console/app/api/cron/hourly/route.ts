// Tick horaire (rollups, nouvelles erreurs, anomalies) — ROUTE RETIRÉE (23/09/2026).
//
...
//   railway run --service scheduler node services/scheduler/run-once.mjs hourly
//
  ...
  return Response.json(
    {
      ...
      remplacement: "railway run --service scheduler node services/scheduler/run-once.mjs hourly",
    },
    { status: 410 },
  );
}
