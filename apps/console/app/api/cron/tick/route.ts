// Tick fréquent (alertes, SLO, uptime, livraison des webhooks) — ROUTE RETIRÉE (23/09/2026).
//
  ...
  return Response.json(
    {
      ...
      remplacement: "railway run --service scheduler node services/scheduler/run-once.mjs tick",
    },
    { status: 410 },
  );
}
