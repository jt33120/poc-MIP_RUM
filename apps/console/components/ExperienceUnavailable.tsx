/** Absence de LCP : ne jamais habiller l'inconnu d'une note numérique. */
export function ExperienceUnavailable() {
  return (
    <div className="flex h-[260px] flex-col items-center justify-center gap-2 text-center" data-testid="xp-unavailable">
      ...
      <p className="max-w-xs text-xs text-ink-faint">Aucune mesure exploitable sur cette période.</p>
    </div>
  );
}
