// Icônes inline (tracés style lucide, ISC) — zéro dépendance, stroke currentColor.
...
export const ICON_PATHS = {
  ...
  // roue crantée — réglages d'un écran (composition du tableau de bord)
  settings: (
    <>
  ...
  // bouclier — Vie privée / DSAR
  shield: <path d="M12 22s8-4 8-10V5l-8-3-8 3v7c0 6 8 10 8 10z" />,
  // cadenas — capacité inactive / nécessite une configuration externe
  lock: (
    <>
  ...
  // point d'interrogation — aide contextuelle (InfoTip / glossaire)
  help: (
    <>
      <circle cx="12" cy="12" r="10" />
  ...
  // boussole — guide de navigation (tour)
  compass: (
    <>
      <circle cx="12" cy="12" r="10" />
