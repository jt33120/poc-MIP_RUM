...
import { q } from "./db";
import { FUSEAU_DEFAUT, fuseauConnu } from "./fuseau-local";

// Le calcul des jours et heures locaux, SANS la base, vit dans `fuseau-local.ts` ;
// ce module ne garde que la lecture du fuseau d'une application (`app_registry`).
// Réexporté ici : les appelants de `fuseauDe` n'ont qu'un import à écrire.
export * from "./fuseau-local";
