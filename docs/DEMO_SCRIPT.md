...
- [ ] Chiffres en tête : **robot 1,14 s « ok » vs LCP p75 réel 4,04 s « poor » = +254 %** sur
      `/login` (constaté en prod le 10/06/2026) ; SDK cœur **23,8 KB gzip** ; OTLP standard.
...
2. **« Encore un agent JS qui va ralentir mon site »** — « 23,8 KB gzip pour le cœur, mesuré ;
