...
| `console-api` | 2 · Restitution | Backend de la console : identité, sessions, écrans, écritures, administration, RGPD. Seul client : le serveur Vercel. [Ce qu'il doit porter](console-api/README.md) | public, garde par secret client | à venir (piste C, C0 → C12) ; ré-inventaire C-R fait, cliquet posé : 51 écrans sur 57 atteignent encore la base |
