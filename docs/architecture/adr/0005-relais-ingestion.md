...
5. **La date de fin** : après au moins 7 jours à 100 % sans repli, les routes deviennent des relais purs et le chemin d'écriture local disparaît (P6b) ; puis la collecte directe au collector pour les sites sans CSP figée (P6b.G), qui seule permet la géolocalisation par adresse.
...
- Le texte de conformité doit changer AVANT la première montée du drapeau (Vercel reçoit et relaie, Railway pseudonymise et écrit) : garde humaine, PR #285, prérequis n° 6 du [mode d'emploi](../../operations/relais-ingestion.md).
