...
// Même parser que le dev-server local (shared/otlp.mjs ; copie déployée en sibling ./otlp.mjs).
...
import { flattenOtlp } from "../../../shared/otlp.mjs";
...
import { createSchemaCompatibleWriter } from "../../../shared/write-causal.mjs";
...
// Auth d'ingestion partagée avec v1-replay (shared/auth.mjs) : registre d'apps
...
// En-têtes CORS (règles partagées shared/cors.mjs) — l'origine n'est reflétée
